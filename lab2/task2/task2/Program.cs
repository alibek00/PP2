...
namespace task2
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            using (FileStream fs = new FileStream(@"C:\text\first.txt", FileMode.Open, FileAccess.Read))
            {
            ...
            using (FileStream fs1 = new FileStream(@"C:\text\first.txt", FileMode.Create, FileAccess.Write)) //создал файл, если сущ то перезаписывается
            {
